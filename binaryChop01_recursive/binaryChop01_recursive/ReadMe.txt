========================================================================
    KONSOLENANWENDUNG: binaryChop01_recursive-Projektübersicht
========================================================================

Diese binaryChop01_recursive-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre binaryChop01_recursive-Anwendung besteht.


binaryChop01_recursive.vcxproj
...
binaryChop01_recursive.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen binaryChop01_recursive.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
